...
public class ObjectsApplication implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(new MyAuthInterceptor()).addPathPatterns("/objects/**").addPathPatterns("/settings").addPathPatterns("/download/**").addPathPatterns("/deleteBucket/**").addPathPatterns("/deleteobj/**");
